...
public:
     ...
     * @return this vector updated
     */
    Vector3 &operator*=(const double &o) noexcept {
        m_data[0] *= o;
        m_data[1] *= o;
        m_data[2] *= o;
        return *this;
     ...
     */
    [[nodiscard]] Vector3 operator*(const double &o) const noexcept {
        Vector3 t(*this);
        t *= o;
        return t;
    }
     ...
     * @return the resultant vector
     */
    [[nodiscard]] friend Vector3 operator*(const double &o, const Vector3 &v) noexcept {
        Vector3 t(v);
        t *= o;
        return t;
    }
